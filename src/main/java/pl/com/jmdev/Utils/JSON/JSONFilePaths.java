...
public class JSONFilePaths {
    ...
    public static final String membersJSONFilePath = "appSettings/membersToNewConversation.json";
    public static final String mySettingsFilePath = "appSettings/emailServerSettings.json";
