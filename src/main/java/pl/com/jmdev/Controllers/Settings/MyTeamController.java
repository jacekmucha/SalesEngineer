...
import pl.com.jmdev.Helpers.ComboBox.MyTeamComboBoxHelper;
...
import pl.com.jmdev.Helpers.Member.MemberToTableViewHelper;
import pl.com.jmdev.Model.Member;
import pl.com.jmdev.Utils.CSVHelper.CSVReader;
...
public class MyTeamController {
    ...
    public void initialize() {
        ...
        myTeamName.setCellValueFactory(new PropertyValueFactory<MemberToTableViewHelper, String>("name"));
        myTeamEmail.setCellValueFactory(new PropertyValueFactory<MemberToTableViewHelper, String>("email"));
    ...
    private void createMembersLists(ObservableList<MemberToTableViewHelper> dataList) {
        ...
        try {
            ...
            if (br != null) {
                ...
                for (int i = 0; i < 5; i++) {
                    Member memberFromCSV = new Member();
                    memberFromCSV.setName("Osoba #" + i);
                    memberFromCSV.setEmail("osoba" + i + "@example.com");
                    membersFromCSV.add(memberFromCSV);
                }
